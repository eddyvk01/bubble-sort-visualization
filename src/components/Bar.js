...
export default function Bar({ index, length, color, changeArray }) {
  ...
  const colors = [
    ["rgba(61,90,241,0.5)", "rgba(g1,90,241,0.2)"],
    ["rgba(255,48,79,1)", "rgba(255,48,779,0.5)"],
    ...
    <>
      <div className="bar">
        ...
        <div className="quantity-nav">
            <div className="quantity-button quantity-up" style= {quantity} onClick={increament}>{' '}+{' '} </div>
